...
// What this file protects: the DAEMON runner's auto-start.
//
// The local runner spawns the resolved launcher itself; that path and its
// tests live in autostart.go / autostart_test.go.
//
