...
def main():
    ...
    parser.add_argument('output_folder_path', type=str, help='Output folder where to save the LFS file')
    parser.add_argument('output_file_name', type=str, help='New name of the downloaded file')
