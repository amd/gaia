...
def main():
    ...
    for file in os.listdir(wheels_path):
        if file.endswith('.whl'):
            ...
            subprocess.run([sys.executable, '-m', 'pip', 'install', os.path.join(wheels_path, file)])
    ...
    lemonade_models_path = os.path.join(folder_path, 'gaia_env', 'Lib', 'site-packages', 'turnkeyml', 'llm', 'tools', 'ort_genai', 'models')
