---
title: "MCP Client Specification"
description: "Technical specification for connecting GAIA agents to external MCP servers"
icon: "plug"
---

<Info>
**Source Code:** [`src/gaia/mcp/client/`](https://github.com/amd/gaia/tree/main/src/gaia/mcp/client)
</Info>
...
- **Stdio & HTTP Transports**: Support for subprocess and remote MCP servers
...
<Note>
**License**: This specification is part of the GAIA project and is subject to the [project's license](https://github.com/amd/gaia/blob/main/LICENSE).
</Note>
