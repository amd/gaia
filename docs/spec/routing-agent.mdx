...
<Info>
  **Source Code:** [`hub/agents/routing/python/gaia_agent_routing/agent.py`](https://github.com/amd/gaia/blob/main/hub/agents/routing/python/gaia_agent_routing/agent.py)
</Info>
