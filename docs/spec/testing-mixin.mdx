...
<Info>
  **Source Code:** [`hub/agents/code/python/gaia_agent_code/tools/testing.py`](https://github.com/amd/gaia/blob/main/hub/agents/code/python/gaia_agent_code/tools/testing.py)
</Info>

<Note>
**Component:** TestingMixin
**Module:** `gaia_agent_code.tools.testing`
