...
<Info>
  **Source Code:** [`hub/agents/code/python/gaia_agent_code/tools/web_dev_tools.py`](https://github.com/amd/gaia/blob/main/hub/agents/code/python/gaia_agent_code/tools/web_dev_tools.py)
</Info>
