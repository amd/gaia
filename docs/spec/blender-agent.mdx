...
<Info>
  **Source Code:** [`hub/agents/blender/python/gaia_agent_blender/agent.py`](https://github.com/amd/gaia/blob/main/hub/agents/blender/python/gaia_agent_blender/agent.py)
</Info>
