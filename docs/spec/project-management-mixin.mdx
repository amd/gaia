...
<Info>
  **Source Code:** [`hub/agents/code/python/gaia_agent_code/tools/project_management.py`](https://github.com/amd/gaia/blob/main/hub/agents/code/python/gaia_agent_code/tools/project_management.py)
</Info>

<Note>
**Component:** ProjectManagementMixin
**Module:** `gaia_agent_code.tools.project_management`
**Import:** `from gaia_agent_code.tools.project_management import ProjectManagementMixin`
</Note>
---
