...
class SSEOutputHandler(OutputHandler):
    ...
    def __init__(
        ...
        self.allow_unconfirmed_tools = (
            os.environ.get("GAIA_API_ALLOW_UNCONFIRMED_TOOLS") == "1"
    ...
    def confirm_tool_execution(self, tool_name, tool_args) -> bool:
        ...
        Emits a ``tool_confirm_denied`` event naming the tool, why it was
        refused, and to use the Agent UI instead. Returns True only under the
        opt-in escape hatch; see /sdk/infrastructure/api-server.
        """
