...
def __init__(
    ...
    Args:
        ...
        model_id: Model ID for local LLM (default: None — resolve_default_chat_model(): config default_model, which gaia init sets from the hardware, else DEFAULT_MODEL_NAME, Gemma-4-E4B-it-GGUF)
