...
async def list_models() -> ModelListResponse:
    ...
    Example:
        ...
        (AGENT_MODELS is empty by default — the list stays empty until an
        agent is registered in src/gaia/api/agent_registry.py. A registered
...
# Empty by default: the server starts and serves an empty /v1/models list
