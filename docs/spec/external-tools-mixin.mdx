...
<Info>
  **Source Code:** [`hub/agents/code/python/gaia_agent_code/tools/external_tools.py`](https://github.com/amd/gaia/blob/main/hub/agents/code/python/gaia_agent_code/tools/external_tools.py)
</Info>
