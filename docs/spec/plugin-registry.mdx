...
[Custom Agents guide](/sdk/core/agent-system) for
...
ready-to-edit `agent.py`. See the [Custom Agents guide](/sdk/core/agent-system)
...
- [Custom Agents guide](/sdk/core/agent-system) — Python agent recipes and
