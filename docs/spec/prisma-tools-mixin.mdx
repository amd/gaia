...
<Info>
  **Source Code:** [`hub/agents/code/python/gaia_agent_code/tools/prisma_tools.py`](https://github.com/amd/gaia/blob/main/hub/agents/code/python/gaia_agent_code/tools/prisma_tools.py)
</Info>

<Note>
**Component:** PrismaToolsMixin
**Module:** `gaia_agent_code.tools.prisma_tools`
