...
**Module:** `gaia_agent_code.orchestration.orchestrator`
**Import:** `from gaia_agent_code.orchestration.orchestrator import Orchestrator, ExecutionResult, CheckpointAssessment`
</Note>
---
...
[project]
dependencies = [
    "gaia_agent_code.orchestration.checklist_generator",
    "gaia_agent_code.orchestration.checklist_executor",
    "gaia_agent_code.orchestration.steps.error_handler",
    "gaia_agent_code.orchestration.project_analyzer",
]
```
