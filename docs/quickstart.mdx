...
<Tabs>
  <Tab title="Windows">
    ...
    <Note>
      Use `--profile chat` for the full experience (~25GB) or `--profile minimal` for a quick start (~400MB).
...
<CardGroup cols={2}>
  <Card title="Connect to External Tools" icon="plug" href="/guides/mcp/client">
