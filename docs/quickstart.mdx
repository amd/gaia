...
<Info>
  **First time here?** Complete the [Setup](/setup) guide first to install GAIA and Lemonade Server.
</Info>

## Build Your First Agent

<Warning>
  Make sure your virtual environment is activated (you should see `(.venv)` in your prompt). If commands aren't working as expected, try prefixing them with [`uv run`](https://docs.astral.sh/uv/reference/cli/#uv-run).
</Warning>
