...
**Just want to chat?** Install the desktop app in 2 steps -- no terminal required.
...
<Tip>
  The desktop app includes everything: Lemonade Server, models, and the chat interface. For document Q&A, drag PDFs or code files into the chat. See the [GAIA Chat Desktop guide](/guides/chat-ui) for more features.
</Tip>
