...
- `tools/call` - Execute a specific tool. Check `result.isError`: it is `true` when the tool ran but failed

See the [MCP integration guide](/integrations/mcp#json-rpc-methods) for the full method list.
