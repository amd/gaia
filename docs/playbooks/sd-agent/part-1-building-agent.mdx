...
1. Calls `_get_mixin_prompts()` → Gets `[sd_prompt, vlm_prompt]` from mixins (automatic)
2. Calls `_get_system_prompt()` → Gets your custom instructions about the custom tool
