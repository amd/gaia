...
```python
    ...
    def _get_system_prompt(self) -> str:
        # Composable system prompts: mixins provide domain knowledge
        # SDToolsMixin.get_sd_system_prompt() returns research-backed SD guidelines
        # Agent base class auto-composes: mixin prompts + this return value
...
class ImageStoryAgent(Agent, SDToolsMixin, VLMToolsMixin):
    ...
    def _get_system_prompt(self) -> str:
        # Compose system prompt from mixin-provided fragments
        # SDToolsMixin provides SD-specific prompt engineering guidelines
        # Tool schemas are automatically injected by Agent base class
        return self.get_sd_system_prompt()
