...
<Info>
  **Source Code:** [`hub/agents/chat/python/`](https://github.com/amd/gaia/blob/main/hub/agents/chat/python/) | [`src/gaia/rag/sdk.py`](https://github.com/amd/gaia/blob/main/src/gaia/rag/sdk.py) | [`examples/hardware_advisor_agent.py`](https://github.com/amd/gaia/blob/main/examples/hardware_advisor_agent.py)
</Info>
...
<Steps>
  ...
  <Step title="Add capabilities" icon="puzzle-piece">
    Once comfortable, add voice with the **[Talk Guide](/guides/talk)** or explore the **[flagship GAIA agent](/guides/gaia)**.
  </Step>

  <Step title="Go advanced" icon="star">
    Build complex systems with custom tool mixins — see **[Composing Skills](/guides/composing-skills)**.
  </Step>
