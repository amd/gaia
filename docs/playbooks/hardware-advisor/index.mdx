...
2. Queries the available model catalog with download sizes
...
graph TD
    ...
    style F fill:#A87B2D,stroke:#A87B2D,stroke-width:2px,color:#fff
    ...
    linkStyle 0,1,2,3,4,5,6,7 stroke:#E2A33E,stroke-width:2px
```
...
- Model catalog with download sizes for recommendations
...
def list_available_models() -> Dict[str, Any]:
    ...
    try:
        ...
        for model in models_data:
            ...
            # Get the catalog download size for this model
...
recommend_models(ram_gb=32, gpu_memory_mb=8192)
  ...
  2. Fetch model catalog:
      ...
      → Enrich with download sizes via get_model_info()
