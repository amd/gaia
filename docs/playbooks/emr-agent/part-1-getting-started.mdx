...
<Info>
  **Source Code:** [`hub/agents/python/emr/`](https://github.com/amd/gaia/blob/main/hub/agents/python/emr/)
</Info>
...
**Source code:** [`hub/agents/python/emr/gaia_agent_emr/agent.py`](https://github.com/amd/gaia/blob/main/hub/agents/python/emr/gaia_agent_emr/agent.py)
