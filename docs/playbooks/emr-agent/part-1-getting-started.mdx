...
<Info>
  **Source Code:** [`hub/agents/emr/python/`](https://github.com/amd/gaia/blob/main/hub/agents/emr/python/)
</Info>
...
graph TD
    ...
    style H fill:#A87B2D,stroke:#A87B2D,stroke-width:2px,color:#fff
  ...
  <Step title="Set up your project">
    ...
    <Tabs>
      ...
      <Tab title="Developer (Editable Install)">
        ...
        uv pip install -e hub/agents/emr/python
        ```
...
**Source code:** [`hub/agents/emr/python/gaia_agent_emr/agent.py`](https://github.com/amd/gaia/blob/main/hub/agents/emr/python/gaia_agent_emr/agent.py)
