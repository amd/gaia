    ...
    AGENT_MODELS = {
        ...
        "doc-qa": {
            ...
            "init_params": {
                ...
                # see ChatAgentConfig in src/hub/agents/python/chat/gaia_agent_chat/agent.py.
...
<CardGroup cols={2}>
  <Card title="ChatAgent" icon="code" href="https://github.com/amd/gaia/blob/main/src/hub/agents/python/chat/gaia_agent_chat/agent.py">
