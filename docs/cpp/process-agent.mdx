...
<Info>
  **Source Code:** [`cpp/examples/process_agent.cpp`](https://github.com/amd/gaia/blob/main/cpp/examples/process_agent.cpp) — single-file, self-contained agent (~2,900 lines including 7 tools, action menu, and decision support).
</Info>
...
<Steps>
  ...
  <Step title="Start Lemonade Server">
    Open the installed Lemonade application and use its model controls to load a chat model.
...
flowchart LR
    ...
    style CLASS fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style MENU fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style ACT fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
...
flowchart TD
    ...
    style START fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style SS fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style LP fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style CLASS fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style CONC1 fill:#2d8a2d,stroke:#4CAF50,stroke-width:2px,color:#fff
    style MENU fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style EX fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style CONF_S fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style CONF_R fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style EX_Q fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style CONF_Q fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style KILL fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style RESTART fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style QUAR fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    ...
    style MBALLOON fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
