...
**Dependencies:** nlohmann/json, cpp-httplib, yaml-cpp, Google Test (all fetched automatically)
</Note>
...
flowchart TD
    ...
    style A fill:#E2A33E,stroke:#EFC480,stroke-width:2px,color:#1a1a1a
    style B fill:#E2A33E,stroke:#EFC480,stroke-width:3px,color:#1a1a1a
    style C fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    ...
    style F fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
...
graph LR
    ...
    style S fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style A fill:#E2A33E,stroke:#EFC480,stroke-width:2px,color:#1a1a1a
    ...
    style E fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    linkStyle default stroke:#E2A33E,stroke-width:2px
```
...
graph TB
    ...
    style User fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Agent fill:#E2A33E,stroke:#EFC480,stroke-width:3px,color:#1a1a1a
    style LLM fill:#A87B2D,stroke:#E2A33E,stroke-width:2px,color:#fff
    style MCP fill:#EFC480,stroke:#E2A33E,stroke-width:2px,color:#1a1a1a
    style Shell1 fill:#8B1117,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Shell2 fill:#8B1117,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Shell3 fill:#8B1117,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Shell4 fill:#8B1117,stroke:#E2A33E,stroke-width:2px,color:#fff
    style FileWrite fill:#8B1117,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Notepad fill:#8B1117,stroke:#E2A33E,stroke-width:2px,color:#fff
