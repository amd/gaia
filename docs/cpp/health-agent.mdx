...
The System Health Agent is a C++ port of the [Python Windows System Health Agent](/guides/mcp/windows-system-health). It connects to the Windows MCP server via stdio, then uses PowerShell commands to gather system metrics and generate health reports.
...
<CardGroup cols={2}>
  ...
  <Card title="Python System Health Agent" icon="python" href="/guides/mcp/windows-system-health">
    The Python version of this agent using MCPClientMixin
  </Card>
