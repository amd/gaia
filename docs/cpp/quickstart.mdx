...
See the [Testing Guide](/cpp/testing) for the full test suite — unit tests (8 modules), integration tests (LLM, MCP, Wi-Fi, Health), CI pipeline, and how to add new tests.
