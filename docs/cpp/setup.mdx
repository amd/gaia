...
<Tabs>
  <Tab title="Windows">
    ...
    Or download directly from the [Lemonade v11.7.0 release page](https://github.com/lemonade-sdk/lemonade/releases/tag/v11.7.0).
...
| Git | any | `git --version` |
| [Lemonade Server](https://lemonade-server.ai) | 11.7.0 | `lemonade-server --version` |
