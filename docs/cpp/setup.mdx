...
<Tabs>
  <Tab title="Windows">
    ...
    Download and run the installer (v11.0.0):
    ...
    Or download directly from the [Lemonade v11.0.0 release page](https://github.com/lemonade-sdk/lemonade/releases/tag/v11.0.0).
...
| Git | any | `git --version` |
| [Lemonade Server](https://lemonade-server.ai) | 11.0.0 | `lemonade-server --version` |
