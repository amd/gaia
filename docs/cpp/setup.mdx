...
<Tabs>
  <Tab title="Windows">
    ...
    Download and run the installer (v10.9.0):
    ...
    Or download directly from the [Lemonade v10.9.0 release page](https://github.com/lemonade-sdk/lemonade/releases/tag/v10.9.0).
...
| Git | any | `git --version` |
| [Lemonade Server](https://lemonade-server.ai) | 10.9.0 | `lemonade-server --version` |
