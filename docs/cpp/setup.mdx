...
<Tabs>
  <Tab title="Windows">
    ...
    Or download directly from the [Lemonade v11.5.2 release page](https://github.com/lemonade-sdk/lemonade/releases/tag/v11.5.2).
...
| Git | any | `git --version` |
| [Lemonade Server](https://lemonade-server.ai) | 11.5.2 | `lemonade-server --version` |
