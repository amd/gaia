...
<Tabs>
  <Tab title="Windows">
    ...
    Download and run the installer (v10.1.0):
  ...
  <Tab title="Linux">
    ...
    Download and install the `.deb` package (v10.1.0):
...
| Git | any | `git --version` |
| [Lemonade Server](https://lemonade-server.ai) | 10.1.0 | `lemonade-server --version` |
