...
The [C++ Agent Framework](/guides/cpp) shipped in Q1 2026 as a native C++17 port of the base agent — same agent loop, tool registry, and MCP support, compiled to a standalone binary with no Python runtime. The next phase focuses on production readiness:
...
→ [View C++ framework docs](/guides/cpp) • [View milestone on GitHub](https://github.com/amd/gaia/milestone/10)
