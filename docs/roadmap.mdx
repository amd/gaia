...
graph TD
    subgraph Q1["Q1 2026"]
        ...
        D("SD Agent<br/><i>Stable Diffusion optimization</i>")
    end

    subgraph Q2["Q2 2026"]
        E("MCP Docs Server<br/><i>AI assistant context</i>")
    end

    subgraph Q3["Q3 2026"]
        F("Community-Driven<br/><i>Vote on GitHub</i>")
    end
    ...
    style F fill:#2d2d2d,stroke:#555,stroke-width:2px,color:#fff
