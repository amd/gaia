...
<CardGroup cols={3}>
  <Card title="Desktop App" icon="desktop" href="/quickstart#desktop-app-fastest">
    Download, install, and start chatting -- no terminal required.
  </Card>
...
<Tabs>
  <Tab title="Python">
    <CardGroup cols={2}>
      <Card title="Chat Desktop" icon="desktop" href="/guides/chat-ui">
        Privacy-first desktop chat with drag-and-drop document Q&A. No cloud, no subscriptions.
      </Card>
