...
|---|---|---|---|
| **Windows** | [SignPath OSS Foundation](https://signpath.org/products/foundation) | API token | **Free** for OSS |
...
SignPath provides free Windows code signing for open-source projects via their [Foundation tier](https://signpath.org/products/foundation). One-time setup, takes ~1 week for OSS approval.

### Step 1: Apply for SignPath OSS

1. Go to [https://signpath.org/products/foundation](https://signpath.org/products/foundation)
...
- SignPath OSS Foundation: [https://signpath.org/products/foundation](https://signpath.org/products/foundation)
