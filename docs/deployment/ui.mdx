...
<Info>
  **Source Code:** [`src/gaia/apps/`](https://github.com/amd/gaia/blob/main/src/gaia/apps/) | [`src/gaia/ui/`](https://github.com/amd/gaia/blob/main/src/gaia/ui/) | [RAUX Repository](https://github.com/aigdat/raux)
</Info>
