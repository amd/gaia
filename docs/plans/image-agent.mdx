...
graph TD
    ...
    style Core fill:#ED1C24,stroke:#C8171E,stroke-width:2px,color:#fff
    style Enhance fill:#ED1C24,stroke:#C8171E,stroke-width:2px,color:#fff
    style Params fill:#ED1C24,stroke:#C8171E,stroke-width:2px,color:#fff
    style Eval fill:#ED1C24,stroke:#C8171E,stroke-width:2px,color:#fff
    style CLI fill:#ED1C24,stroke:#C8171E,stroke-width:2px,color:#fff
    style Gallery fill:#ED1C24,stroke:#C8171E,stroke-width:2px,color:#fff
    style LLM fill:#F4484D,stroke:#ED1C24,stroke-width:2px,color:#fff
    style VLM fill:#F4484D,stroke:#ED1C24,stroke-width:2px,color:#fff
    style SD fill:#F4484D,stroke:#ED1C24,stroke-width:2px,color:#fff
    style DB fill:#2d2d2d,stroke:#555,stroke-width:2px,color:#fff
    style Files fill:#2d2d2d,stroke:#555,stroke-width:2px,color:#fff

    style UI fill:transparent,stroke:#F4484D,stroke-width:2px,stroke-dasharray: 5 5,color:#F4484D
    style Agent fill:transparent,stroke:#ED1C24,stroke-width:2px,stroke-dasharray: 5 5,color:#ED1C24
    style Backend fill:transparent,stroke:#F4484D,stroke-width:2px,stroke-dasharray: 5 5,color:#F4484D
...
gaia sd submit "a dragon in a cave" --model SDXL-Turbo
