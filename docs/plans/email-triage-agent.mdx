...
| DB-backed agent reference | `MedicalIntakeAgent` | `hub/agents/emr/python/gaia_agent_emr/agent.py` | **Reference** — DatabaseMixin + @tool + FileWatcherMixin composition |
