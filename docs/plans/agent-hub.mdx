...
Beyond community engagement, GAIA Agents Hub serves three objectives:
...
**Moonshot targets** require strong community activation.
...
| First competition prize pool | Budget amount | TBD |
...
- [GAIA SDK Documentation](https://amd-gaia.ai/docs/sdk)
