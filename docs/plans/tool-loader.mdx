...
<Info>
  **Source Code:** [`src/gaia/agents/base/tool_loader.py`](https://github.com/amd/gaia/blob/main/src/gaia/agents/base/tool_loader.py) · bundles [`src/hub/agents/python/chat/gaia_agent_chat/tool_bundles.py`](https://github.com/amd/gaia/blob/main/src/hub/agents/python/chat/gaia_agent_chat/tool_bundles.py)
</Info>
...
[`tool_bundles.py`](https://github.com/amd/gaia/blob/main/src/hub/agents/python/chat/gaia_agent_chat/tool_bundles.py):
...
[`DOC_CORE_TOOLS`](https://github.com/amd/gaia/blob/main/src/hub/agents/python/chat/gaia_agent_chat/tool_bundles.py)
...
1. **Bundle definitions and CORE membership** — *decided.* CORE = 10 names and 12
   bundles, in [`tool_bundles.py`](https://github.com/amd/gaia/blob/main/src/hub/agents/python/chat/gaia_agent_chat/tool_bundles.py)
