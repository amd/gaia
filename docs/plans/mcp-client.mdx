...
<Info>
**Status:** Shipped (base mixin landed in v0.15.4; see `src/gaia/mcp/mixin.py`). Remaining
work tracked here is CUA-specific: richer desktop-automation tooling, security
review, and example CUA agents.
**Priority:** High
...
- [MCP Client](/sdk/sdks/mcp) - Current MCP client support
