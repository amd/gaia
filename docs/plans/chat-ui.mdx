...
**Priority:** High
[View full plan on GitHub](https://github.com/amd/gaia/blob/main/docs/plans/chat-ui.mdx) • [Vote with 👍](https://github.com/amd/gaia/issues/167)
</Info>
...
<Card title="Full Implementation Plan" icon="github" href="https://github.com/amd/gaia/blob/main/docs/plans/chat-ui.mdx">
