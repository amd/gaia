...
<CardGroup cols={2}>
  <Card title="Agent UI Plan" icon="file" href="https://github.com/amd/gaia/blob/main/docs/plans/agent-ui.md">
    Comprehensive technical plan with implementation details
  </Card>
  <Card title="Email & Calendar" icon="envelope" href="https://github.com/amd/gaia/blob/main/docs/plans/email-calendar-integration.md">
    Email triage, calendar agent, Outlook integration, meeting notes
  </Card>
  <Card title="Messaging Adapters" icon="comments" href="https://github.com/amd/gaia/blob/main/docs/plans/messaging-integrations-plan.md">
    Signal, Discord, Slack, Telegram bi-directional chat
  </Card>
  <Card title="Security Model" icon="shield" href="https://github.com/amd/gaia/blob/main/docs/plans/security-model.md">
