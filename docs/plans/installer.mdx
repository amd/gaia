...
|----------|--------|-----------|
| **Python bundling** | Require Python 3.10+ pre-installed | Keeps installer small (<10KB), users manage Python |
...
|---------|--------|----------|
| GAIA | PyPI | `GET https://pypi.org/pypi/amd-gaia/json` → `.info.version` |
| Lemonade | GitHub | `GET https://api.github.com/repos/lemonade-sdk/lemonade/releases/latest` → `.tag_name` |
...
Installers:
  - Architecture: x64
    ...
    InstallerSha256: <computed-at-release>
    InstallerSwitches:
      Silent: /S
...
| winget review turnaround | < 48 hours |
