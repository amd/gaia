...
- **[GAIA Chat Desktop](/guides/chat-ui)** — Desktop app with GUI and document Q&A
- **[Chat UI SDK](./chat-ui)** — Python backend for the desktop application (FastAPI, SQLite, REST API)
