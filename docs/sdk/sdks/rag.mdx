...
3. Generates embeddings for all chunks. A short, empty, or dimensionally inconsistent batch fails indexing with an actionable error; partial vectors are never paired with different chunks.
