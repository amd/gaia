...
# Create a session
session = db.create_session(title="My Chat", model="Qwen3.5-35B-A3B-Instruct-GGUF")
  ...
  <Accordion title="GET /api/system/status">
    ...
    **Response:**
    ```json
    {
      ...
      "model_loaded": "Qwen3.5-35B-A3B-Instruct-GGUF",
...
config = AgentConfig(
    model=session.get("model", "Qwen3.5-35B-A3B-Instruct-GGUF"),
