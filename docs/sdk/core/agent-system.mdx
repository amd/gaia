...
"make" or "generate" with a file as the direct object (`notes.md`, not "a
Node.js app" or "a summary of app.log") is a save request. An answer's save claims are checked when the user asked for a save, a
file-writing tool ran, or the answer says "I" or "we" saved something; so "I think
downloads are saved to ~/Downloads" stays an answer.
