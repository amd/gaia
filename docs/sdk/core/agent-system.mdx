...
source text visible, aligns to whole lines where possible, and preserves verbatim
field values; only a final sentence-period difference on an identical source
span is tolerated during comparison. Conflicting evidence fails visibly.
