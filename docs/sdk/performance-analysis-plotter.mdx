---
title: "Performance Analysis Plotter"
icon: "chart-bar"
---
...
The script expects llama.cpp server logs, not GAIA setup output. Export the backend log from your running Lemonade installation and pass that file to the plotter:
