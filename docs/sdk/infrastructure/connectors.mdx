...
await configure("mcp-github", {"GITHUB_PERSONAL_ACCESS_TOKEN": "ghp_..."})

# Retrieve — used by the MCP bridge to launch the server.
creds = await get_credential("mcp-github")
# {"env": {"GITHUB_PERSONAL_ACCESS_TOKEN": "ghp_..."}, "command": "npx", "args": [...]}
```
