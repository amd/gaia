...
<Info>
  **Quick Install Available:** Skip this page if you're using the [Chat UI](/quickstart#chat-ui-fastest) or [one-command installer](/quickstart#cli-install) - they handle all prerequisites automatically.
</Info>
