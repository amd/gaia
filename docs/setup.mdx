...
<Info>
  **Quick Install Available:** Skip this page if you're using the [Agent UI](/quickstart#agent-ui-npm) or [one-command installer](/quickstart#cli-install) - they handle all prerequisites automatically.
</Info>
