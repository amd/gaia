...
<Info>
  **Quick Install Available:** Skip this page if you're using the [desktop app](/quickstart#desktop-app-fastest) or [one-command installer](/quickstart#cli-install) - they handle all prerequisites automatically.
</Info>
