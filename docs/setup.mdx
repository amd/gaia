...
<Tip>
  **Recommended Configuration:** The SDK has been primarily tested on a GMKtec NucBox EVO-X2 with AMD Ryzen AI MAX+ 395 w/ Radeon 8060S (or comparable) with 128GB RAM, using the Qwen3.5-35B-A3B-Instruct-GGUF LLM running on the iGPU.
</Tip>
