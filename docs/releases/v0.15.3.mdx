...
This release shipped an SD Agent Playbook and an SD User Guide. Both pages were removed in v0.24.0 along with the standalone `sd` agent — image generation is now part of the flagship agent's tool surface.
