...
See [SD Agent Playbook](https://amd-gaia.ai/docs/playbooks/sd-agent) for complete tutorial, and [SD User Guide](https://amd-gaia.ai/docs/guides/sd) for CLI reference.
