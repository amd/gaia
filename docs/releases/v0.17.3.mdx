...
- Follow the new custom-installer playbook at [`docs/playbooks/custom-installer/index.mdx`](https://github.com/amd/gaia/blob/8eb53c6b/docs/playbooks/custom-installer/index.mdx) to distribute GAIA with your agents pre-loaded — useful for workshops, team deployments, and internal tooling
