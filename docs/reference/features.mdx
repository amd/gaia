...
For detailed instructions on installing and managing models, see the [Lemonade Server Model Management documentation](https://lemonade-server.ai/docs/server/server_models/) or the [CLI Reference](/reference/cli#init-command).
