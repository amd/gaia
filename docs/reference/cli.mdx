...
| `--claude-model` | string | claude-sonnet-4-20250514 | Claude model used with `--use-claude`; `--model` is ignored then |
...
| `--claude-model` | string | `claude-sonnet-4-20250514` | Claude model to use when `--use-claude` is set |
