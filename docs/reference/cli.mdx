...
built-in) is the alternative: published Strix Halo measurements put its generation
several times faster than Qwen3.8 Flash, but it reads text only. Switch to it with
