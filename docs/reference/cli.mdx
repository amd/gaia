...
| `--remote` | flag | false | Use remote Lemonade server (skip local server start) |
...
| `rag` | Qwen3-Coder-30B, nomic-embed, Qwen2.5-VL | Document Q&A with retrieval | ~25 GB |
| `all` | All models | Complete installation | ~26 GB |
