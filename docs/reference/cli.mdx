...
- Report killed, refused, and failed listeners; exit 1 on any refusal, failure, or empty port. Listing and forceful termination commands each have a five-second timeout.
