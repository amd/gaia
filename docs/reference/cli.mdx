...
An agent that runs out of steps before finishing still answers: it gets one more model call with no tools and reports what it found, what it couldn't finish and why, and what you can do next. If that last call fails, you get the step-limit notice plus a line saying why the summary couldn't be written.
