...
See the dedicated page for the code-fixing prompt testbench, including usage, examples, scenarios, and options: [Fix Code Testbench](./eval/fix-code-testbench).

## Examples

See the [evaluation configs](https://github.com/amd/gaia/tree/main/src/gaia/eval/configs) directory for sample configurations and test data.
