...
| "Agent processing failed" | Run `gaia init` and inspect the reported model/readiness error |
...
<Steps>
  <Step title="Start Servers">
    Prepare Lemonade and the configured model:
