...
<Info>
  **Source Code:** [`hub/agents/blender/python/gaia_agent_blender/agent.py`](https://github.com/amd/gaia/blob/main/hub/agents/blender/python/gaia_agent_blender/agent.py) · [`src/gaia/mcp/blender_mcp_server.py`](https://github.com/amd/gaia/blob/main/src/gaia/mcp/blender_mcp_server.py)
</Info>
