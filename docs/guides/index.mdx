...
| Do a bit of everything in one agent | [GAIA](/guides/gaia) |
| Build a chatbot or document Q&A | [Document Q&A](/guides/chat) |
| Add voice to your agent | [Voice Interaction](/guides/talk) |
| Research the web from the CLI | [Browser Agent](/guides/browse) |
| Run SQL over structured rows | [Analyst Agent](/guides/analyze) |
...
| Generate images from text | [Image Generation](/guides/sd) |
