...
```bash
# Model used for routing analysis (default: Qwen3.5-35B-A3B-Instruct-GGUF)
export AGENT_ROUTING_MODEL=Qwen3.5-35B-A3B-Instruct-GGUF
...
**Solution**:
- Check the routing model is loaded: `AGENT_ROUTING_MODEL=Qwen3.5-35B-A3B-Instruct-GGUF`
