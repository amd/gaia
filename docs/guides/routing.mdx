...
flowchart LR
    ...
    linkStyle 3,4 stroke:#EFC480,stroke-width:2px,stroke-dasharray:5
```
...
- Source code: `hub/agents/routing/python/gaia_agent_routing/agent.py`
- System prompt: `hub/agents/routing/python/gaia_agent_routing/system_prompt.py`
- CLI integration: `hub/agents/code/python/gaia_agent_code/cli.py` (search for "RoutingAgent")
