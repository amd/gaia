...
graph TB
    ...
    style Shell1 fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Shell2 fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Shell3 fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Format fill:#EFC480,stroke:#E2A33E,stroke-width:2px,color:#1a1a1a
    style Clipboard fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Notepad fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
    style Paste fill:#2d2d2d,stroke:#E2A33E,stroke-width:2px,color:#fff
...
<CardGroup cols={2}>
  ...
  <Card title="Windows MCP Server" icon="windows" href="https://pypi.org/project/windows-mcp/">
