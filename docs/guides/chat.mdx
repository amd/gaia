...
<Note>
  **Prefer a desktop app?** See [GAIA Chat Desktop](/guides/chat-ui) for the privacy-first GUI with drag-and-drop document Q&A.
</Note>

<Note>
  **Looking for the API?** See the [Chat SDK Reference](/sdk/sdks/chat) for classes, methods, and code examples.
</Note>
...
<CardGroup cols={2}>
  <Card title="GAIA Chat Desktop" icon="desktop" href="/guides/chat-ui">
    Privacy-first desktop app with drag-and-drop document Q&A
  </Card>

  <Card title="Chat SDK Reference" icon="code" href="/sdk/sdks/chat">
  ...
  <Card title="Chat UI SDK Reference" icon="server" href="/sdk/sdks/chat-ui">
