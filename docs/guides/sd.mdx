...
| Model | Best For | Recommended Size | Speed |
|-------|----------|------------------|-------|
| **SD-Turbo** | Fast iteration, testing | 512x512 | ~2-3 sec |
| **SDXL-Turbo** | Higher quality | 1024x1024 | ~5-8 sec |
