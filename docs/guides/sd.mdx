...
description: Generate images using Stable Diffusion on Ryzen AI
---

# Image Generation Guide

Generate images from text descriptions using Stable Diffusion, running on Ryzen AI through Lemonade Server.
