...
The C++ framework communicates with any OpenAI-compatible chat completions endpoint. **[Lemonade Server](https://lemonade-server.ai) is the recommended and tested backend** — it runs models locally on AMD hardware (GPU and NPU). Other OpenAI-compatible servers may work but have not been validated.

## Use in Your Project

See the [Integration Guide](/guides/cpp/integration) for FetchContent, find_package, git submodule, and shared library methods.
