...
| Semantic chunks extracted | 24,349 |
...
Wall-clock time scales with your Lemonade Server throughput. On a local Ryzen AI setup the embedding step runs on the NPU; over a remote server (e.g. ngrok tunnel) it is network-bound. For retrieval-quality metrics see [#868](https://github.com/amd/gaia/issues/868).
