...
<AccordionGroup>
  ...
  <Accordion title="Research Agent — RAG + file search">
    ...
    it up itself (see [the RAG tools mixin contract](/docs/spec/rag-tools-mixin)
    ...
    class ResearchAgent(Agent, RAGToolsMixin, FileSearchToolsMixin):
        ...
        def __init__(self, documents: Optional[List[str]] = None):
            ...
            # before super().__init__() runs _register_tools().
  ...
  <Accordion title="Code Review Agent — shell + file I/O">
    ...
    class CodeReviewAgent(Agent, FileIOToolsMixin, ShellToolsMixin):
        ...
        def __init__(self, documents: Optional[List[str]] = None):
            ...
            # here, before super().__init__() runs _register_tools().
