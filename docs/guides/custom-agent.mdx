...
<Note>
  ...
  When it's ready to **share** — so anyone can install it from the [Agent Hub](/hub) —
...
**anyone install it** from the [Agent Hub](/hub) (and PyPI/npm), package it as a hub
...
<CardGroup cols={2}>
  ...
  <Card title="Claude Code skills" icon="robot" href="/guides/hub-publishing">
