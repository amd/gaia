...
<Tabs>
  <Tab title="Windows">
    ...
    5. **Recommended**: leave the *"Start GAIA Agent UI when I sign in to Windows"* checkbox ON so GAIA is always available in the system tray.
  ...
  <Tab title="Linux (Debian/Ubuntu)">
    ...
    3. Install with apt:
       ...
       ```
    4. Launch GAIA from your application menu, or run `gaia-ui` from a terminal
