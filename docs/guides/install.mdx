...
The uninstaller offers an optional checkbox to also remove your data (chats, documents, settings).
...
| What | Location |
|---|---|
| Electron app | Platform-specific (Program Files / /Applications / /usr/lib/gaia-ui) |
