...
<Note>
GAIA is a desktop chat application that runs AI agents locally on your machine. This is the recommended install method for most users. For the developer / CLI install path, see the [Python CLI install plan](/plans/installer).
</Note>
