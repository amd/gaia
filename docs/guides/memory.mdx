...
This happens *after* your answer is on screen, in the background, so it never adds to how long you wait for a reply. A fact you state may take a few more seconds to appear in the Memory Dashboard than the answer itself did.
