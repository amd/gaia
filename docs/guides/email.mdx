...
This path is additive and gated behind `GAIA_EMAIL_AGENT_MODE`; the existing
in-process email path is unchanged until the supersede decision
([#1767](https://github.com/amd/gaia/issues/1767)) lands.
