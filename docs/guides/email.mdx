...
All of the personalization above — inbox profiling, behavioral auto-promotion, and preference persistence — depends on the agent's memory. You can disable it, so nothing is read from or written to memory:
