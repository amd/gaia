...
if defined INSTALL_DIR (
    ...
    echo set "GAIA_MODE=HYBRID" >> "%INSTALL_DIR%\gaia_env\etc\conda\activate.d\env_vars.bat"
    echo SUCCESS: Created conda activation script for GAIA_MODE=HYBRID in %INSTALL_DIR%\gaia_env
    ...
    echo SUCCESS: Created conda activation script for GAIA_MODE=HYBRID
)
