        ...
        if from_user == False: # streaming from agent
            for i, chunk in enumerate(chunks):
                ...
                if new_card:
                    ...
                    self.update_card(self.complete_message, '0', stats, final_update, from_user)
                time.sleep(0.1)
...
"""
        ...
        # Test YouTube link
        youtube_message = "Check out this cool video: https://www.youtube.com/watch?v=dQw4w9WgXcQ"
        self.stream_message(youtube_message, from_user=False)

        youtube_message = "Can you index this video? https://www.youtube.com/watch?v=dQw4w9WgXcQ"
