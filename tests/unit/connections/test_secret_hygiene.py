...
The plain rule: a refresh token must NEVER appear in:
  - any ``logging`` record produced by ``gaia.connections.*``
...
from gaia.connections.errors import ConnectionRevokedError
from gaia.connections.providers import _registry
from gaia.connections.store import save_connection
from gaia.connections.tokens import get_or_refresh
...
class TestFiles:
    def test_no_sentinel_in_grants_file(self, seeded, tmp_path):
        ...
        from gaia.connections.grants import grant_agent
