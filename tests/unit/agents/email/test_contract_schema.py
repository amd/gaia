...
def test_schema_version_unchanged_by_multi_inbox():
    """Schema 2.1 (#1780) is the current frozen contract version.

    2.1 added the calendar surface (view/create/respond) to the REST contract
    (additively on top of the 2.0 5-bucket taxonomy). If this fails, someone
