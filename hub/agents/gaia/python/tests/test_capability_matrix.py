...
# 89: 81 on main (69 after #3023's `remember_skill_lesson`, plus the email and
# image_gen bundles, `run_python` and `capture_skill`), plus this branch's eight
# browser tools.
_EXPECTED_TOOLS_TOTAL = 89
...
# 23: the browser tools arrive as two bundles, `browser_nav` and `browser_use`.
