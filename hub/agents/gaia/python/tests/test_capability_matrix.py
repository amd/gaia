...
# 83: 69 after #3023's `remember_skill_lesson`, plus the email and image_gen
# bundles and `run_python` from main, `capture_skill`, and the persistent
# shell session's `get_shell_state` / `reset_shell_session`.
