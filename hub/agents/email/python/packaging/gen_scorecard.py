...
scorecard to ``hub/agents/email/npm/SCORECARD.md`` (a single file, updated
...
# packaging/ -> python/ -> email/ -> agents/ -> hub/ -> repo root
...
_NPM_ROOT = _REPO_ROOT / "hub" / "agents" / "email" / "npm"
...
def main(argv=None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            f"(default: hub/agents/email/npm/, writes {_OUTPUT_FILENAME})."
        ),
    )
    parser.add_argument(
        "--limit",
