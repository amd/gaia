...
Usage (from an activated venv with the deps + pyinstaller installed)::
    ...
    python hub/agents/email/python/packaging/freeze.py            # one-dir (default)
    python hub/agents/email/python/packaging/freeze.py --onefile  # one-file

Output:
    one-dir:  hub/agents/email/python/packaging/dist/email-agent/email-agent[.exe]
    one-file: hub/agents/email/python/packaging/dist/email-agent[.exe]
...
NAME = "email-agent"
# Repo root: packaging/ -> python/ -> email/ -> agents/ -> hub/ -> <root>
