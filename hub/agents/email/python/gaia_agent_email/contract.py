...
class EmailPreScanResult(_Strict):
    ...
    total_unread: Optional[int] = Field(
        default=None,
        description=(
            "Estimated total UNREAD messages in the scanned mailbox(es), the "
            "denominator for scan coverage (#2584). Gmail reports a real API "
            "estimate; Outlook cannot honestly provide one and reports null — "
