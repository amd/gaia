...
[**Scorecard**](https://github.com/amd/gaia/blob/agent-pkg-email-v0.7.0/hub/agents/email/npm/SCORECARD.md)
...
[Scorecard's *Reproduction* section](https://github.com/amd/gaia/blob/agent-pkg-email-v0.7.0/hub/agents/email/npm/SCORECARD.md#reproduction)
