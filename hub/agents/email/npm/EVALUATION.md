...
[`SCORECARD.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SCORECARD.md);
...
a **Claude judge** ([`eval_drafting_report.py`](https://github.com/amd/gaia/blob/main/hub/agents/email/python/packaging/eval_drafting_report.py),
...
[`llm_triage.py`](https://github.com/amd/gaia/blob/main/hub/agents/email/python/gaia_agent_email/tools/llm_triage.py);
...
are in [`SCORECARD.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SCORECARD.md).

## Reproducing the scorecard

The **exact, version-stamped command** that produced the current numbers lives in
[`SCORECARD.md` → *Reproduction*](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SCORECARD.md#reproduction).
