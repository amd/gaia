...
**Eval scorecard (v0.3.0): aggregate 83.4 / 100** — within-one-bucket **acceptance** accuracy (3-run mean, 95% CI [82.1, 84.7]) over the full 249-email labeled corpus ([`SCORECARD.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SCORECARD.md)). Triage priority is ordinal, so the bar (#1437) credits exact-or-adjacent buckets — what users feel — not exact 4-way match (reported as a secondary, 0.77). The linked scorecard carries the full recipe, metrics + reported secondaries, run-to-run variance/CI, a per-category breakdown, the run environment, and a worked recomputation; [`EVALUATION.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/EVALUATION.md) is the companion guide — what's measured, the dataset, a worked example, and step-by-step reproduction.
...
> Using an AI coding assistant? This package ships a [`SKILL.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SKILL.md) — load
...
progress. See [`SPEC.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SPEC.md) → *Readiness vs liveness*.
...
[`SPEC.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SPEC.md) for the complete surface.
...
and [`SKILL.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SKILL.md)
...
- [`SPEC.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SPEC.md) — full API, lifecycle helpers, connectors, module format, and platforms.
- [`CAPABILITY_MATRIX.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/python/CAPABILITY_MATRIX.md) — code-derived, CI-guarded inventory of every capability surface (internal tools, REST, MCP, eval coverage).
- [`SKILL.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SKILL.md) — load into Claude Code (or similar) for a step-by-step integration playbook.
- [`SCORECARD.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/SCORECARD.md) — latest eval results (score, metrics, per-category breakdown, run environment).
- [`EVALUATION.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/EVALUATION.md) — evaluation guide: what's measured, the dataset, a worked example, and how to reproduce the scorecard.
- [`CHANGELOG.md`](https://github.com/amd/gaia/blob/main/hub/agents/email/npm/CHANGELOG.md) — version history.
