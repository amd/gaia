 ...
 * round-trip -> clean tree-kill shutdown. Prints the triage result.
 *
...
async function main() {
  ...
  try {
    ...
    log("POST /v1/email/triage (single email) ...");
    ...
    log(
      `PROOF: kind=${res.request_kind} category=${res.result.category} ` +
