...
pip install -e hub/agents/emr/python     # editable, for development
```
...
```bash
cd hub/agents/emr/python/gaia_agent_emr/dashboard/frontend
npm install
npm run build
```
...
```bash
pip install -e ".[test]"
pytest hub/agents/emr/python/tests/ -x
