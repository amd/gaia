...
```bash
pytest -xvs hub/agents/python/blender/tests/test_agent_v1.py -k "not integration"
```
...
```bash
pytest -xvs hub/agents/python/blender/tests/test_agent_v1.py -k "integration"
```
...
```bash
pytest -xvs hub/agents/python/blender/tests/test_agent_v1.py
```

To skip integration tests regardless of whether MCP server is running:

```bash
pytest -xvs hub/agents/python/blender/tests/test_agent_v1.py --skip-integration
```
