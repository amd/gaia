...
Download and install Lemonade Server v11.0.0, then start it:

**Windows:**
```powershell
# Download and run the MSI installer
curl -L -o lemonade-server-minimal.msi https://github.com/lemonade-sdk/lemonade/releases/download/v11.0.0/lemonade-server-minimal.msi
...
Or browse all platform options on the [Lemonade v11.0.0 release page](https://github.com/lemonade-sdk/lemonade/releases/tag/v11.0.0).
