...
Install Lemonade Server v2026.39.1:

**Windows:**
```powershell
# Download and run the MSI installer
curl -L -o lemonade-server-minimal.msi https://github.com/lemonade-sdk/lemonade/releases/download/v2026.39.1/lemonade-server-minimal.msi
...
Or browse all platform options on the [Lemonade v2026.39.1 release page](https://github.com/lemonade-sdk/lemonade/releases/tag/v2026.39.1).
