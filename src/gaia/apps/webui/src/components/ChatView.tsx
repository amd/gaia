...
import { Edit3, Paperclip, Download, Send, Upload, MessageSquare, Square, ArrowDown, Lock, FileText, FolderSearch, CheckCircle2, X, Link, Brain, EyeOff, Bot, ChevronDown, Plus } from 'lucide-react';
