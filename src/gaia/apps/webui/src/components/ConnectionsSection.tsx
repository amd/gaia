 ...
 * flow opens the system browser; the SSE hook (useConnectionsSSE) updates
...
import { useConnectionsSSE } from '../hooks/useConnectionsSSE';
...
const PROVIDERS = [
    {
        ...
        // narrower or wider scopes via REQUIRED_CONNECTIONS, and re-connect
