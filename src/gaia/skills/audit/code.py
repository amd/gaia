...
SINKS: dict[str, Sink] = {
    ...
    "pty.spawn": Sink(
        ...
        "code.shell.os_system",
        "high",
        "Spawns a pseudo-terminal process.",
        _SHELL_REMEDIATION,
    ),
    "asyncio.create_subprocess_shell": Sink(
        ...
        "code.shell.subprocess",
        "high",
        "Spawns a subprocess through the shell.",
        _SHELL_REMEDIATION,
    ),
