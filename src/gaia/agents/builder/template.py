...
def _render_basic(
    ...
    return [
        ...
        *_build_class_attrs(agent_id, agent_name, card_description, starters),
        ...
        "",
        '    # A starter-template caveat is appended after the "---" below (added by the',
        "    # Builder). Delete that trailing block once your agent has real tools/MCP, so",
        "    # it stops disclaiming abilities it now has.",
