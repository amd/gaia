...
class AgentOrchestrator:
    ...
    def route(self, query: str, context: Optional[Dict[str, Any]] = None, use_llm: bool = False) -> Agent:
        ...
        if not agent_id:
            logger.warning(f"No specific agent found for query: '{query}'. Falling back to chat agent.")
            agent_id = "chat"
