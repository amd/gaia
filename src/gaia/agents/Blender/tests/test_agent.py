...
<<<<<<< HEAD
    ...
    "create_red_cube": json.dumps({
        ...
        "plan": [
            {"tool": "create_object", "tool_args": {"type": "CUBE", "name": "red_cube"}},
            {"tool": "set_material_color", "tool_args": {"object_name": "red_cube", "color": [1,0,0,1]}}
        ],
        "tool": "create_object",
...
<<<<<<< HEAD
        ...
        with patch.object(agent, '_create_fallback_response', return_value=fallback_response):
            # Also mock _extract_json_from_response to ensure it returns None
            with patch.object(agent, '_extract_json_from_response', return_value=None):
...
<<<<<<< HEAD
        plan_response = json.dumps({
            ...
            "plan": [
                {"tool": "clear_scene", "tool_args": {}},
                {"tool": "create_object", "tool_args": {"type": "CUBE", "name": "plan_cube", "location": [0,0,0]}},
                {"tool": "set_material_color", "tool_args": {"object_name": "plan_cube", "color": [1,0,0,1]}},
                {"tool": "create_object", "tool_args": {"type": "SPHERE", "name": "plan_sphere", "location": [0,0,2]}}
            ],
            "tool": "clear_scene",
            "tool_args": {}
        })
