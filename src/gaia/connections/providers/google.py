...
"""
Google OAuth 2.0 provider for ``gaia.connections``.
...
``REQUIRED_CONNECTIONS`` has an entry here.
"""
...
# REQUIRED_CONNECTIONS; the UI/CLI render the description, never the URL.
