...
"""
OAuth provider registry for ``gaia.connections``.
...
from gaia.connections.providers.base import (  # noqa: F401  re-export
...
def get(provider_id: str) -> OAuthProvider:
    ...
    if provider_id == "google":
        ...
        from gaia.connections.providers.google import GoogleOAuthProvider
